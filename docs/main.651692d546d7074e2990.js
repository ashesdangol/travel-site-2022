...
function RevealOnScroll_createClass(Constructor, protoProps, staticProps) { if (protoProps) RevealOnScroll_defineProperties(Constructor.prototype, protoProps); if (staticProps) RevealOnScroll_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
function StickyHeader_createClass(Constructor, protoProps, staticProps) { if (protoProps) StickyHeader_defineProperties(Constructor.prototype, protoProps); if (staticProps) StickyHeader_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }




var StickyHeader = /*#__PURE__*/function () {
  function StickyHeader(el, scrolledPx) {
  ...
  StickyHeader_createClass(StickyHeader, [{
    ...
    value: function runOnScroll() {
      ...
      this.pageSections.forEach(function (el) {
        return _this2.calcScrolledSection(el);
      });
    }
  }, {
    ...
    key: "calcScrolledSection",
    value: function calcScrolledSection(el) {
...
new modules_RevealOnScroll(document.querySelectorAll(".testimonial"), 85);
var stickyHeader = new modules_StickyHeader(document.querySelector(".site-header"), 60);
var modal;
document.querySelectorAll(".open-modal").forEach(function (el) {
  el.addEventListener("click", function (e) {
    ...
    if (typeof modal == "undefined") {
      __webpack_require__.e(/* import() | modal */ 582).then(__webpack_require__.bind(__webpack_require__, 222)).then(function (x) {
        modal = new x["default"]();
        setTimeout(function () {
...
/******/ 			return "" + "modal" + "." + "211d0bd124b3dbc1dcc0" + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "travel-site-2022:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunktravel_site_2022"] = self["webpackChunktravel_site_2022"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [885], () => (__webpack_require__(409)))
